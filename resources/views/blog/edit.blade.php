            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12 mt-3">
                        ...
                        <input type="file" class="form-control" name="thumbnail">
                            @if(!empty($blog->thumbnail))
                                <img src="{{asset('upload/blog/'.$blog->thumbnail)}}" alt="" width="200px" class="img-thumbnail mt-3">
                            @endif
                        <small class="text-danger">@error ('thumbnail') {{$message}} @enderror</small>
                    </div>
                    <div class="col-md-12 mt-3">
                            <label for="category_id"> category</label>
                            <input type="text" class="form-control" name="category" value="{{old('category',$blog->category)}}">
                    ...
                    <div class="col-md-12 mt-4">
                        ...
                        <input type="text" class="form-control" name="work" value="{{old('work' , $blog->work)}}">
