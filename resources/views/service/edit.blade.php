            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12 mt-3">
                        ...
                        <input type="file" class="form-control" name="img">
                            @if(!empty($service->img))
                                <img src="{{asset('upload/service/'.$service->img)}}" alt="" width="200px" class="img-thumbnail mt-3">
                            @endif
                    ...
                    <div class="col-md-12 mt-4">
                        ...
                        <input type="text" class="form-control" name="info" value="{{old('info' , $service->info)}}">
